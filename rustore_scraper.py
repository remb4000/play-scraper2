...
# 🔥 Усиленные заголовки (Обходим защиту от ботов)
HEADERS = {
...
for query in deep_queries:
    ...
    # 1. Запрашиваем список игр по ключевому слову (Правильное формирование параметров!)
    search_url = "https://backapi.rustore.ru/applicationData/search"
    search_params = {
        "query": query,
        "limit": 20,
        "offset": 0
    ...
    try:
        ...
        # Защита от вылета: проверяем, что сервер ответил нормально (Код 200)
